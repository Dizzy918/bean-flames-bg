        ...
        <div className="mx-auto max-w-7xl px-6 py-24">
          <div className="mb-12 max-w-2xl">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Всяка партида преминава през контролирано сушене и пресоване за
              максимална плътност и калоричност.
            </p>
          </div>
          ...
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-lg text-muted-foreground">
                100% рециклирана суровина. Дълго горене. Ниска пепел. Произведени
                от утайка от кафе, събирана от партньорски обекти в София.
              </p>
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-7xl px-6 py-24">
          <div className="mb-12 max-w-2xl">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Стандартният размер на пелетите ги прави съвместими с повечето
              отоплителни системи на пазара.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-[var(--bean)]/40 via-card to-[var(--moss)]/15 p-12 md:p-20">
            ...
            <div className="relative grid gap-10 md:grid-cols-2 md:items-center">
              <div>
                ...
                <p className="mt-6 text-lg text-muted-foreground">
                  Кафе пелетите предлагат сравнима калоричност с дървесните, но
                  без да натоварват горските екосистеми.
                </p>
                <Link
                  to="/concept"
